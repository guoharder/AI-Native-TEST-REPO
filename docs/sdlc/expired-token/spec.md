Sandbox still unavailable. This is pure content authoring from the provided intent/source context, so I'll write spec.md directly here to be persisted into the repo as `spec.md`.
